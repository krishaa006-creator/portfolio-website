...
export default function About() {
  ...
  const [brainLeftRef, brainLeftVisible]   = useReveal(0.1);
  const [brainRightRef, brainRightVisible] = useReveal(0.1);
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-10 md:gap-14 items-start">
        ...
        >
          ...
          <div className="mt-8 relative inline-block">
            ...
            <div
              className="relative z-10 bg-[#FFFBF2] border border-[#1A1A1A]/12 rounded-[22px] p-6 w-[260px]
      ...
      <div className="max-w-7xl mx-auto mt-20 md:mt-28 border-t border-[#1A1A1A]/10 pt-16 md:pt-20">
        <div className="grid md:grid-cols-12 gap-10 md:gap-14 items-center">
          <div
            ...
            style={{
              animation: brainLeftVisible ? "revealLeft 0.65s cubic-bezier(0.22,1,0.36,1) both" : "none",
              opacity: brainLeftVisible ? undefined : 0,
            }}
          >
          ...
          <div
            ...
            style={{
              animation: brainRightVisible ? "revealRight 0.65s cubic-bezier(0.22,1,0.36,1) 100ms both" : "none",
              opacity: brainRightVisible ? undefined : 0,
            }}
          >
            <div className="relative group w-full max-w-[420px]">
              ...
              <div
                className="relative bg-[#FFFBF2] p-3 pb-12 rounded-[6px] shadow-[0_22px_45px_-22px_rgba(0,0,0,0.45),0_2px_4px_rgba(0,0,0,0.08)]
                  transition-transform duration-500 group-hover:-translate-y-2 group-hover:rotate-0 group-hover:shadow-[0_32px_55px_-22px_rgba(0,0,0,0.35)]"
